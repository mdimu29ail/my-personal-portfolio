...
const NavBar = () => {
  ...
  return (
    <div className=" bg-gray-800 text-white shadow-sm sticky top-0 z-40">
      <div className="container mx-auto navbar">
        <div className="navbar-start ">
          ...
          <h2 className="text-4xl font-bold inline-block italic">
            <span className="text-orange-600">I</span>mu
          </h2>
        </div>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 space-x-3">{items}</ul>
        </div>
